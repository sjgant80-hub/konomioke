...
function startArena(){
  ...
  if(POLL_SIG.bc){var prev=POLL_SIG.bc.onmessage;POLL_SIG.bc.onmessage=function(e){
    ...
    if(e.data&&e.data.type==='blast'&&e.data.peerId!==POLL_SIG.peerId){
      ...
      m.position.set((Math.random()-.5)*4,2.5,8);scene.add(m);
